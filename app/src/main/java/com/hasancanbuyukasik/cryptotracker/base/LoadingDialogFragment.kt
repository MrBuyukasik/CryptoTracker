...
import com.hasancanbuyukasik.cryptotracker.databinding.LoadingDialogFragmentBinding
...
class LoadingDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.loading_dialog_fragment, container, false)
        return binding.root
    }
